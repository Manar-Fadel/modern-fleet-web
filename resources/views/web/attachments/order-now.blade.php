                ...
                <div class="container">
                    <div class="calculator-form-inner">
                        ...
                        <p class="text-center mb-3" style="color: #b36761">
                            ...
                            {{ __('web.You can order multiple attachments for muti vehicles in same order by clicking on Add another brand') }}
                        </p>
                        ...
                        <input type="hidden" name="type" id="type" :value="'attachments'">

                        <div v-for="(request, index) in requests" :key="index" class="calculator-form-inner mb-10 border p-5">
                            <input type="hidden" onload="request.is_attachments_enabled = true">
