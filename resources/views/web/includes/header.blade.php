                    ...
                    <div class="header-wrapper-1">
                        <div class="logo-area-start">
                            <a href="{{ route('home') }}" class="logo">
                                <img src="{{ asset("logo.png") }}" alt="logo_area">
                            </a>
                        </div>
                                    ...
                                    <ul class="">
                                        ...
                                        <li class="has-dropdown main-nav">
                                            ...
                                            <ul class="submenu parent-nav">
                                                <li>
                                                    <a @if(request()->route()->getName() == "home")
                                                           href="#ourCarsSection"
                                                       @else
                                        ...
                                        @if(auth()->check())
                                            <li class="main-nav">
                                                <a href="{{ route('my-orders.index') }}"
                                                   @if(request()->route()->getName() == 'my-orders.index')
                                                       class="main-menu active"
                                                   @else
                                                       class="main-menu"
                                                    @endif>
                                    ...
                                    <div class="button-area">
                                        ...
                                        @if(auth()->check())
                                                <div class="has-dropdown main-nav dropdown d-inline-block">
                                                    ...
                                                    <ul class="submenu parent-nav dropdown-menu dropdown-menu-end shadow"
                                                        aria-labelledby="addOrderDropdown"
                                                        style="min-width: 260px;border-radius: 8px;">

                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-2"
                                                               href="{{ route('order-now', ['type' => 'car']) }}">
                                                                🚗 {{ __('web.Car Order') }}
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-2"
                                                               href="{{ route('order-now', ['type' => 'heavy-vehicle']) }}">
                                                                🚛 {{ __('web.Heavy Vehicle Order') }}
                                                            </a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-2"
                                                               href="{{ route('order-now', ['type' => 'attachments']) }}">
                                                                🛠️ {{ __('web.Attachments Order') }}
                                                            </a>
                                                        </li>
                                            ...
                                            @else
                                            <a href="{{ route('login') }}" class="rts-btn btn-primary radius-big icon">
                                                {{ __('web.Add Order') }}
                                        ...
                                        <a href="{{ route('change-language') }}" class="rts-btn btn-black icon">
                                            {{ app()->getLocale() == 'en' ? 'AR' : 'EN' }}
                                        </a>
                                    </div>
                                    <div class="menu-btn" id="menu-btn">
                                        <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <rect width="55" height="55" rx="15" fill="#25285f" />
