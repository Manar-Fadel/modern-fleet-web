<div class="rts-footer-area footer-two footer-bg-2" id="rts-footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <li>
                                    <a class="main-menu"
                                       @if(request()->route()->getName() == "home")
                                           href="#ourCarsSection"
                                       @else
                                           href="{{ route('home', ['#ourCarsSection']) }}"
                                        @endif>
                                        {{ __('web.Our Cars') }}
                                    </a>
                                </li>
                    ...
                    <div class="single-wized">
                        ...
                        <div class="body">
                            <p class="phone d-flex align-items-center">
                                ...
                                <a href="tell:{{$customer_care_mobile}}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-area-inner d-flex align-items-center justify-content-between">
                        <p>{{ __('web.Copyright') }}
                            {{ __('web.All Rights Reserved by') }} Modern Fleet  
                            ©
                            <script>
                                document.write(
