            ...
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    <h1 class="text-xl font-medium leading-none text-gray-900">
                        ALL News & Adv. In Website ({{ count($cars) }})
                    </h1>
        ...
        <div class="container-fixed">
            <span class="grid gap-5 lg:gap-7.5">
                <span class="flex gap-5 lg:gap-7.5">
                        ...
                        <table class="table table-auto table-border" data-datatable-table="true">
                            ...
                            @foreach($cars as $model)
                                <tr>
                                    ...
                                    <td class="text-gray-800 font-normal">
                                        <img alt="{{ $model->title_en }}" src="{{ $model->main_image_url }}" width="400px" height="200px;">
                                    </td>
                                    <td class="text-gray-800 font-normal">
                                        {{ isset($model->brand) ? $model->brand->name : '' }} /
                                        {{ isset($model->carModel) ? $model->carModel->name : '' }} /
                                        {{ isset($model->year) ? $model->year->value : '' }}
                                    </td>
                                    <td class="text-gray-800 font-normal">
                                    ...
                                    <td class="text-gray-800 font-normal">
                                        <img alt="" src="{{ $model->slider_image_url }}" width="400px" height="200px;">
                                    </td>
                                    <td class="text-gray-800 font-normal">
                                        {{ $model->created_at }}
                                    </td>
                    ...
                    @else
                        <p>There is no news or adv. yet</p>
                    @endif
                </span>
