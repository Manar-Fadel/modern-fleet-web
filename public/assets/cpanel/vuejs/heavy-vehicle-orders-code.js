    ...
    methods: {
        ...
        async fetchOrders () {
            ...
            const response = await fetch(
                "/api/admin/heavy-vehicle-requests?search_word="+this.search_word+"&brand_id="+this.brand_id+"&year="+this.year+"&month="+this.month+"&week="+this.week+"&stat_start_date="+this.stat_start_date+"&stat_to_date="+this.stat_to_date,
                {
                    method: 'GET',
